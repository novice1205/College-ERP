...
const Login = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-center p-5 md:p-14 my-20 poppins" style={{ backgroundColor: 'inherit' }}>
      {/* Left section */}
      ...
      <div className="w-full md:w-1/2 max-w-md bg-white p-8 shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* <div className="space-y-2">
            <label htmlFor="college code" className="block text-sm font-medium" style={{ color: '#4299E1' }}>College Code</label>
            <input
              id="password"
              type="password"
